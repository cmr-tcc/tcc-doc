...
O objetivo deste trabalho é comparar a execução nativa de programas escritos em Rust com a execução dos mesmos programas compilados para WebAssembly no navegador, analisando o impacto em desempenho e consumo de recursos. Para isso, foram utilizados algoritmos representativos do The Computer Language Benchmarks Game, adaptados para execução nos dois ambientes e avaliados sob condições controladas para coleta de métricas comparáveis. 
...
Selecionar algoritmos representativos de diferentes classes de problemas computacionais a partir do The Computer Language Benchmarks Game \cite{bench2026}, adequados para execução nos dois ambientes avaliados.
