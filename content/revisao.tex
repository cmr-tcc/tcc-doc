...
Se o desempenho de Rust já impressiona, é na segurança que a linguagem realmente se destaca. Estima-se que cerca de 70\% das vulnerabilidades de segurança catalogadas pelo Microsoft Security Response Center têm origem em erros de gerenciamento de memória \cite{bugden2022}. Rust ataca esse problema de frente com um sistema chamado \emph{ownership} (propriedade).

A ideia é simples: cada valor em Rust tem um único dono. Quando esse dono sai de cena, o valor some junto. Isso impede, por exemplo, que um programa tente usar um dado que já foi descartado, erro conhecido como \emph{use after free}, comum em C e frequentemente explorado por hackers.
