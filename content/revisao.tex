...
Rust é uma linguagem de programação de sistemas que nasceu de uma necessidade real: criar software rápido sem abrir mão da segurança. Desde que a Mozilla começou a patrocinar seu desenvolvimento em 2010, a linguagem foi ganhando espaço na comunidade devido à forma como ela lida com dois problemas que sempre andaram juntos no desenvolvimento de software: desempenho e segurança de memória.
