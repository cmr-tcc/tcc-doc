...
Foi utilizado um intervalo de 2 segundo entre as coletas de memória e CPU. Como essas métricas representam o consumo de recursos do contêiner, foram considerados fatores como o uso de recursos em estado de espera (standby) pelo container e, no caso do Wasm, pelo Puppeteer, além da sobrecarga de carregamento da página web. Para reduzir essa interferência, foi adotado um tempo de 10 segundos em estado ocioso (idle) antes e depois do início dos testes. Além disso, o container era parado e então iniciado antes de cada algoritmo para remover memória em cache.