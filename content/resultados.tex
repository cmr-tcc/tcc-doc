...
Os resultados obtidos permitem identificar que o \emph{overhead} do WebAssembly acompanha a complexidade do acesso à memória de cada algoritmo. Casos com acesso sequencial e previsível, como fannkuch-redux e spectral-norm, ficaram próximos de 13\% ou abaixo, mais próximos da execução nativa. Casos com acesso irregular ou escrita intensiva, como n-body e mandelbrot, chegaram a 69,2\% e 126,9\%.
